(function($) {
	...
	{	
		...
		if(options.colon != false) options.colon.click(function() {print_bbc('','; ',' ')});
		if(options.semi != false) options.semi.click(function() {print_bbc('',': ',' ')});
		if(options.dquote != false) options.dquote.click(function() {print_bbc('quote text','«','»')});
		if(options.ellipsis != false) options.ellipsis.click(function() {print_bbc('','… ','')});
